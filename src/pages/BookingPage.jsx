                    ...
                    <div className="flex justify-between items-center mb-10 bg-white p-4 rounded-2xl border border-luxury-nude shadow-sm">
                        {[
                            ...
                            <div key={step} className="flex items-center gap-2">
                                ...
                                <span className={`text-xs hidden sm:inline font-medium ${currentStep === step ? 'text-luxury-black font-semibold' : 'text-gray-400'
                                    }`}>
                                    {label}
                                </span>
                            </div>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                {categories.map((cat) => (
                                    <button
                                        ...
                                        className={`p-4 rounded-2xl border text-left transition-all ${selectedCategory === cat.id
                                ...
                                <div className="space-y-3">
                                    {categories.find(c => c.id === selectedCategory)?.packages.map((pkg) => (
                                        <div
                                            ...
                                            className={`p-4 rounded-2xl border cursor-pointer transition-all flex justify-between items-center ${selectedPackage?.id === pkg.id
                    ...
                    <div className="bg-white p-6 sm:p-8 rounded-3xl border border-luxury-nude shadow-sm space-y-6">
                        ...
                        {slotError && (
                            <div className="p-4 bg-red-50 text-red-700 text-xs rounded-2xl flex items-center gap-2 border border-red-200 shadow-sm">
                                ...
                                <div>
                                    <strong className="block font-bold">Date Blocked or Unavailable</strong>
                                    <span>{slotError}</span>
                                </div>
                            </div>
                        )}
                                ...
                                <div className="grid grid-cols-3 sm:grid-cols-4 gap-3">
                                    {availableSlots.map((slot) => (
                                        <button
                                            ...
                                            className={`py-3 px-2 rounded-xl text-xs font-bold transition-all flex items-center justify-center gap-1 ${selectedTime === slot
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                {paymentMethods.map((method) => (
                                    <div
                                        ...
                                        className={`p-3.5 rounded-xl border cursor-pointer transition-all ${formData.payment_method === method.id
                                                ? 'border-luxury-gold bg-luxury-cream ring-2 ring-luxury-gold/50'
                                                : 'border-gray-200 hover:border-luxury-rosegold'
                                            }`}
                                    >
