...
import { Calendar as CalendarIcon, Plus, Trash2, Clock, Save, Loader2, CheckCircle2 } from 'lucide-react';
    ...
    <div className="space-y-10">
      ...
      <div className="bg-white p-6 border border-luxury-nude shadow-sm">
        <h2 className="font-serif text-xl font-bold text-luxury-black flex items-center gap-2">
          <Clock size={20} className="text-luxury-pink" /> Operating Hours & Time Ranges
        </h2>
        <p className="text-xs text-gray-500 mt-1">Configure standard daily opening/closing time ranges or block out specific dates and times.</p>
      </div>

      {/* 1. WEEKLY SCHEDULE TIME RANGES EDITOR */}
      <div className="bg-white p-6 border border-luxury-nude shadow-sm space-y-6">
        <div className="flex justify-between items-center border-b pb-4">
          <div>
            ...
            <p className="text-xs text-gray-500">Edit the active working hours for each day of the week.</p>
          </div>
          <button
      ...
      {/* 2. CALENDAR DATE BLOCKING SECTION */}
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        <div className="lg:col-span-6 bg-white p-6 border border-luxury-nude shadow-sm space-y-4">
          ...
          <p className="text-xs text-gray-500">Select any date from the calendar to block out appointments.</p>
          <CalendarPicker
