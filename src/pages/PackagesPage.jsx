    ...
    <div className="pt-28 pb-24 bg-luxury-cream min-h-screen">
      ...
      {loading && (
        <div className="flex flex-col justify-center items-center py-20">
          ...
          <span className="text-sm font-medium text-gray-500">Loading services...</span>
        </div>
      )}
              ...
              {displayedPackages.map((pkg) => (
                ...
                >
                  ...
                  <div className="h-52 w-full overflow-hidden bg-luxury-cream relative">
                    ...
                    />
                    <span className="absolute bottom-3 left-3 bg-luxury-black/80 backdrop-blur-sm text-luxury-gold text-[10px] uppercase font-bold px-3 py-1 rounded-full">
                      {pkg.category_name}
                    </span>
                  </div>
                  ...
                  <div className="p-6 flex-grow flex flex-col justify-between">
                    ...
                    <div className="mt-6 pt-4 border-t border-gray-100">
                      <div className="flex items-baseline justify-between mb-4">
                        <span className="text-xs text-gray-400 font-medium">Service Fee</span>
